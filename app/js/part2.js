(function () {
  ...
  bindPair(document.getElementById("try-choices"), document.getElementById("try-pair"), function (ready) {
    tryNext.disabled = !ready;
  });
  bindPair(document.getElementById("live-choices"), document.getElementById("live-pair"));
